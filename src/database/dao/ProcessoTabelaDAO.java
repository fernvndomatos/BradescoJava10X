...
public class ProcessoTabelaDAO {
    ...
    private static final String SQL_SELECT_BY_PROCESSO_HABILITADO =
            "SELECT * FROM TB_REPLIICACAO_PROCESSO_TABELA WHERE PROCESSO ID = ? AND HABILITADO = TRUE ORDER BY ORDER";
    ...
    private static final String SQL_UPDATE =
            "UPDATE TB+REPLICACAO_PROCESSO_TABELA SET PROCESSO_ID = ?, TABELA_ORIGEM = ?, TABELA_DESTINO = ?, ORDEM = ?, HABILITADO = ?, DS_WHERE = ? WHERE ID = ?";
    ...
    private TB_REPLICACAO_PROCESSO_TABELA map(ResultSet rs) throws SQLException {
        ...
        tb.setHabilitado(rs.getBoolean("HABTLITADO"));
